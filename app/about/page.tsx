      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none">
            ...
            <blockquote className="border-l-4 border-gold-500 pl-8 py-4 bg-gray-50 my-12">
              <p className="text-2xl italic text-gray-900 font-light">
              ...
              <cite className="text-gold-600 font-bold mt-4 block not-italic">— Vince Nepolitan</cite>
            </blockquote>

            <p className="text-xl text-gray-700 leading-relaxed">
              My book &ldquo;Renovate Me&rdquo; is more than a memoir – it&apos;s a blueprint for anyone 
              who feels stuck, broken, or lost. If I can renovate my life, so can you.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gray-100">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-gold-600 font-black text-sm uppercase tracking-[0.3em] mb-4">The Journey</h2>
            <h3 className="text-4xl font-black text-gray-900">FROM PAIN TO PURPOSE</h3>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <h4 className="text-xl font-bold text-gray-900 mt-4 mb-2">{step.title}</h4>
